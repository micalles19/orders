...
?>
<div class="pagetitle">
    <h1><?php echo  $nombre ?> Marca</h1>
    <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Categorias, Catalogos & Marcas</a></li>
            <li class="breadcrumb-item active"><?php echo  $nombre ?> Marca</li>
        </ol>
    </nav>
</div><!-- End Page Title -->
...
<div class="section dashboard">
            ...
            <div class="col-12">
                <div class="card" style="padding-top: 2%;">
                    ...
                    <div class="card-footer" align="center">
                        <button type="button" onclick="marca.validar();" class="btn btn-outline-dark">Guardar</button>
                        <button type="button" onclick="generales.atras('catalogos','administrar_marcas')" class="btn btn-outline-danger">Cancelar</button>
                    </div>
                </div>
    ...
    <script src="./<?php echo $modulo ?>/js/marca.js?version=2"></script>
