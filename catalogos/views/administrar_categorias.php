        ...
        <div class="card-header">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <a href="?module=catalogos&page=categoria" class="btn btn-outline-dark btn-sm">Registrar Categoria
                    </a>
                </div>
...
<script src="./<?php echo $modulo ?>/js/administrarCategorias.js?vesion=5"></script>
