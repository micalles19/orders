...
?>
<div class="pagetitle">
    <h1><?php echo  $nombre ?> Categoría</h1>
    <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Categorias, Catalogos & Marcas</a></li>
            <li class="breadcrumb-item active"><?php echo  $nombre ?> Categoría</li>
        </ol>
    </nav>
</div><!-- End Page Title -->
            ...
            <div class="col-12">
                <div class="card" style="padding-top: 2%;">
                    ...
                    <div class="card-footer" align="center">
                            <button type="button" onclick="categoria.validar();" class="btn btn-outline-dark">Guardar</button>
                            <button type="button" onclick="generales.atras('catalogos','administrar_categorias')" class="btn btn-outline-danger">Cancelar</button>
                    </div>
                </div>
...
<script src="./<?php echo $modulo ?>/js/categoria.js?vesion=5"></script>
