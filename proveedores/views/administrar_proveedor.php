            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <div class="page-title-left">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Administrar Proveedores</a></li>
                        <li class="breadcrumb-item active">Ver Clientes</li>
                    </ol>
                </div>

                <div class="page-title-right">
                    <a href="?module=proveedores&page=proveedor" class="btn btn-outline-dark btn-sm">Nuevo Proveedor
                    </a>
                </div>
...
<script src="./<?php echo $modulo ?>/js/administrarProveedores.js?vesion=5"></script>
